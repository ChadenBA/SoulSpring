...
import { CustomQuizDetailsProps } from './QuizDetails.type';
import { QuizLoSubmission } from 'types/models/Eu';
import { QUIZ_LO_FORM_CONFIG } from './CourseQuizDetails.constants';

function QuizDetails({ onClose, open, lo }: CustomQuizDetailsProps) {
