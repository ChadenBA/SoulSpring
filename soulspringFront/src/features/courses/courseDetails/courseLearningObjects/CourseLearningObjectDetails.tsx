...
import { CourseMediaDetailsProps } from '../courseEducationalUnits/courseEducationalUnitsDetails/CourseMediaDetails.type';

function CourseLearningObjectDetails({
  open,
  scroll,
  lo,
  isEnrolled,
...
export default CourseLearningObjectDetails;
